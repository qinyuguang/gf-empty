...
// arModel is a active record design model for table book operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of book.
	Table = "book"
	// Model is the model object of book.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table book.
	Columns = struct {
		Id        string //   
        Name      string //   
        Author    string //   
